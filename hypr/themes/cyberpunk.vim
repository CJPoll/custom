...
let s:gui08        = "f1fa8c"
let g:base16_gui08 = "f1fa8c"
let s:gui09        = "ff00ff"
let g:base16_gui09 = "ff00ff"
let s:gui0A        = "ff6b35"
let g:base16_gui0A = "ff6b35"
let s:gui0B        = "599cff"
let g:base16_gui0B = "599cff"
let s:gui0C        = "39ff14"
let g:base16_gui0C = "39ff14"
let s:gui0D        = "00f3ff"
let g:base16_gui0D = "00f3ff"
let s:gui0E        = "bd93f9"
let g:base16_gui0E = "bd93f9"
let s:gui0F        = "ff0066"
let g:base16_gui0F = "ff0066"
...
if has("nvim")
  ...
  let g:terminal_color_1  = "#f1fa8c"
  let g:terminal_color_2  = "#599cff"
  let g:terminal_color_3  = "#ff00ff"
  let g:terminal_color_4  = "#00f3ff"
  let g:terminal_color_5  = "#ff6b35"
  let g:terminal_color_6  = "#39ff14"
  let g:terminal_color_7  = "#e0e0ff"
  let g:terminal_color_8  = "#5a5b7d"
  let g:terminal_color_9  = "#f1fa8c"
  let g:terminal_color_10 = "#599cff"
  let g:terminal_color_11 = "#ff00ff"
  let g:terminal_color_12 = "#00f3ff"
  let g:terminal_color_13 = "#ff6b35"
  let g:terminal_color_14 = "#39ff14"
...
call <sid>hi("Debug",         s:gui0F, "", s:cterm0F, "", "", "")
call <sid>hi("Directory",     s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("Error",         s:gui01, s:gui0F, s:cterm01, s:cterm0F, "", "")
call <sid>hi("ErrorMsg",      s:gui0F, s:gui01, s:cterm0F, s:cterm01, "", "")
call <sid>hi("Exception",     s:gui0F, "", s:cterm0F, "", "", "")
call <sid>hi("FoldColumn",    s:gui09, s:gui01, s:cterm09, s:cterm01, "", "")
call <sid>hi("Folded",        s:gui03, s:gui01, s:cterm03, s:cterm01, "", "")
call <sid>hi("IncSearch",     s:gui01, s:gui0C, s:cterm01, s:cterm0C, "none", "")
call <sid>hi("Italic",        "", "", "", "", "italic", "")
call <sid>hi("Macro",         s:gui0F, "", s:cterm0F, "", "", "")
...
call <sid>hi("TooLong",       s:gui0F, "", s:cterm0F, "", "", "")
call <sid>hi("Underlined",    s:gui0F, "", s:cterm0F, "", "", "")
call <sid>hi("Visual",        "", s:gui02, "", s:cterm02, "", "")
call <sid>hi("VisualNOS",     s:gui0F, "", s:cterm0F, "", "", "")
call <sid>hi("WarningMsg",    s:gui0F, "", s:cterm0F, "", "", "")
call <sid>hi("WildMenu",      s:gui0F, s:gui0A, s:cterm0F, "", "", "")
...
call <sid>hi("Special",      s:gui09, "", s:cterm09, "", "", "")
...
" C highlighting
call <sid>hi("cOperator",   s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("cPreCondit",  s:gui0A, "", s:cterm0A, "", "", "")

" Elixir highlighting
call <sid>hi("elixirAtom",                s:gui09, "", s:cterm09, "", "", "")
...
call <sid>hi("elixirSigil",               s:gui08, "", s:cterm08, "", "", "")

" Git highlighting
call <sid>hi("gitcommitOverflow",       s:gui0F, "", s:cterm0F, "", "", "")
...
call <sid>hi("gitcommitBranch",         s:gui0C, "", s:cterm0C, "", "bold", "")
call <sid>hi("gitcommitUntrackedFile",  s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("gitcommitUnmergedFile",   s:gui0F, "", s:cterm0F, "", "bold", "")
call <sid>hi("gitcommitDiscardedFile",  s:gui0F, "", s:cterm0F, "", "bold", "")
call <sid>hi("gitcommitSelectedFile",   s:gui0B, "", s:cterm0B, "", "bold", "")

" GitGutter highlighting
call <sid>hi("GitGutterAdd",     s:gui0B, s:gui01, s:cterm0B, s:cterm01, "", "")
call <sid>hi("GitGutterChange",  s:gui0D, s:gui01, s:cterm0D, s:cterm01, "", "")
call <sid>hi("GitGutterDelete",  s:gui0F, s:gui01, s:cterm0F, s:cterm01, "", "")
...
call <sid>hi("markdownCode",              s:gui0A, "", s:cterm0A, "", "", "")
...
call <sid>hi("phpMethodsVar",      s:gui09, "", s:cterm09, "", "", "")
...
call <sid>hi("rubyInterpolationDelimiter",  s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("rubyRegexp",                  s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("rubySymbol",                  s:gui0B, "", s:cterm0B, "", "", "")
call <sid>hi("rubyStringDelimiter",         s:gui0B, "", s:cterm0B, "", "", "")

" Spelling highlighting
call <sid>hi("SpellBad",     "", "", "", "", "undercurl", s:gui0F)
call <sid>hi("SpellLocal",   "", "", "", "", "undercurl", s:gui09)
call <sid>hi("SpellCap",     "", "", "", "", "undercurl", s:gui0D)
call <sid>hi("SpellRare",    "", "", "", "", "undercurl", s:gui0E)

" Treesitter highlighting (Neovim)
call <sid>hi("@function.call",        s:gui0E, "", s:cterm0E, "", "", "")
call <sid>hi("@function.method.call", s:gui0E, "", s:cterm0E, "", "", "")
...
call <sid>hi("@text.literal",         s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("@text.literal.markdown_inline", s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("@markup.inline.raw",    s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("@text.reference",       s:gui0D, "", s:cterm0D, "", "", "")
call <sid>hi("@markup.strong",        s:gui0B, "", s:cterm0B, "", "bold", "")
call <sid>hi("@text.strong",          s:gui0B, "", s:cterm0B, "", "bold", "")
