---
name: refactor:module-structure
description: Refactor Elixir modules to follow standard ordering conventions (use, import, require, alias, attributes, public, private).
