---
name: beryl:feature-description
description: Generate a comprehensive feature README.md with user stories, technical requirements, and implementation notes.
