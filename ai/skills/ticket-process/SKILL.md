---
name: ticket-process
description: End-to-end ticket completion workflow from Linear through context, planning, test matrices, and test generation.
...
4. Summarize the identified code areas based on the format in
   @~/.claude/skills/format:code-explain/SKILL.md
