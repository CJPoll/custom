---
name: beryl:test-matrix
description: Generate Ruby testing pyramid test matrices for domain and manager layers from feature specs.
...
#### Error Handling
2. **test_operation_returns_error_when_adapter_fails**
   - Setup: Mock adapter returns nil
   - Action: Call manager.operation(params)
   - Assert: Returns {error: "reason"}

#### Edge Cases
3. **test_operation_with_boundary_values**
